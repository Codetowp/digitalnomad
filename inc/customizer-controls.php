 ...
 * @since 1.0
 */
class Digitalnomad_Layout_Control extends WP_Customize_Control {
	/**
	 * Type variable
	 * @access public
	 * @var string
	...
	public function enqueue() {
		wp_enqueue_style( 'digitalnomad-customize-control-layout' );
		wp_enqueue_script( 'digitalnomad-customize-control-layout' );
	}
