...
?> 
 ...
 <?php endwhile;endif;?>
                ...
                <div class="publisher-info">
                    ...
                    <h6><a href="#"><?php echo esc_html_e('By', 'digitalnomad'); ?><?php esc_url(the_author_posts_link()); ?></a></h6>
                </div>
                ...
                <div class="also-like-block"> 
                    <h5><i class="fa fa-link"></i><?php echo esc_html_e('YOU MAY ALSO LIKE', 'digitalnomad'); ?></h5>
