		...
		<div class="row"> 
			...
			<aside class="col-md-4 col-sm-4" > 
				...
				<section class="widget ">
					<div class="user-info"> <img src="<?php echo get_template_directory_uri(); ?>/img/a-2.jpg" class="banner"> 
						<span> <img src="<?php echo get_template_directory_uri(); ?>/img/team/02.jpg">
							<h5>Rijo Abraham</h5>
							<p>Digital Nomad</p>
						</span> 
					</div>
